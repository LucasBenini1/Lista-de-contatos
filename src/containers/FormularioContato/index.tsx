...
const FormularioContato = () => {
    ...
    const cadastrarContato = (evento: FormEvent)=>{
        ...
        dispatch(
            cadastrar({nome, telefone: Number(telefone), email, categoria, favorito: false
            })
        )
        ...
        <S.FormContainer onSubmit={cadastrarContato}>
            ...
            <S.CategoriaFieldset>
                ...
                {Object.values(enums.Categoria).map((categoria)=>(
                    <div key={categoria}>
                        <input type='radio' name='categoria' value={categoria} id={categoria} defaultChecked={categoria === enums.Categoria.AMIGOS} onChange={({target})=> setCategoria(target.value as enums.Categoria)}/>
